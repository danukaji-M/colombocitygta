                ...
                <div class="col-12 justify-content-center mt-lg-5">
                    <div class="row">
                        <div class="col-10 offset-1 col-lg-5 mt-lg-5">
                            <h1 class=" text-uppercase fw-bolder text-light mt-5">කොළඹ නගරේ ROLEPLAY</h1>
                            <span class=" text-light  text-bold text-capitalize">Welcome To Colombo City Roleplay, An
                                immersive GTA FiveM server built on the Nopixel-Inspired Qbcore custom Framework.
                                Delivering
                                An Unmatched Roleplaying Experience. Dive Into Our World, Characterized By Serious
                                Roleplay,
                                A Rich Array Of Over 50 Optimized Jobs, Custom Maps, Scripts, Clothing, Cars, And Much
                                More.
                                Explore A Meticulously Crafted Environment Designed To Provide An Unforgettable
                                Escopode,
